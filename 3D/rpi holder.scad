...
difference()
{
    union()
    {
        difference()
        {
            cylinder(h=3,d=152,$fn=100);
            // assembly holes
            for(i = [[50,50,-1],[-50,50,-1],[50,-50,-1],[-50,-50,-1]])
                translate(i)
                    cylinder(h=7,d=3.5,$fn=32);
            translate([-60,55,-0.001])
                cube([120,30,3.002]);
            translate([-60,-85,-0.001])
                cube([120,30,3.002]);
            
            
            translate([-80,-60,-0.001])
                cube([25,120,8.002]);
            
            translate([-40,-18,-0.001])
                cube([80,36,3.002]);
            translate([-40,31,-0.001])
                cube([80,30,3.002]);
            translate([-40,-61,-0.001])
                cube([80,30,3.002]);
            

       }
        translate([-20.5,24.5,0])
            cylinder(h=8,d=6,$fn=32);
        translate([-20.5,-24.5,0])
            cylinder(h=8,d=6,$fn=32);
        translate([37.5,24.5,0])
            cylinder(h=8,d=6,$fn=32);
        translate([37.5,-24.5,0])
            cylinder(h=8,d=6,$fn=32);
    ...
    // back plate cutout
    translate([55,-60,-0.001])
        cube([25,120,50.002]);
    translate([-20.5,24.5,3])
        cylinder(h=5.002,d=1.5,$fn=32);
    translate([-20.5,-24.5,3])
        cylinder(h=5.002,d=1.5,$fn=32);
    translate([37.5,24.5,3])
        cylinder(h=5.002,d=1.5,$fn=32);
    translate([37.5,-24.5,3])
        cylinder(h=5.002,d=1.5,$fn=32);
}
